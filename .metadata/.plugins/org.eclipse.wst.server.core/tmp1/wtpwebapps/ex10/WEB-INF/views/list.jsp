...
<html>
	<head>
		...
		<style>
			...
			.box{width:200; background:#006400; color:#D2FFD2; float:left; margin:5px; padding:10px; height:180px;}
	...
	<body>
		...
		<form name =frm>
			...
			<select name="perPageNum">
				...
				<option value="6" <c:out value="${pm.cri.perPageNum=='6'?'selected':'' }"/>>6개씩 출력</option>
